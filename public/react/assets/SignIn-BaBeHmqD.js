import{j as e,r as o,u as _,g as F,i as L,y as c,a as z,p as P,P as D}from"./index-VySK2E61.js";import{A as W}from"./AuthPageLayout-nrVpkI04.js";const T=({message:a="Loading..."})=>e.jsx("div",{className:"fixed inset-0 bg-[#080b3d] flex items-center justify-center z-50",children:e.jsxs("div",{className:"flex flex-col items-center gap-3 text-white",children:[e.jsx("div",{className:"w-8 h-8 border-4 border-white/30 rounded-full animate-spin",style:{borderTopColor:"#18e08a"}}),e.jsx("span",{className:"text-sm text-white/70",children:a})]})}),O="/images/bg-mobile.jpeg",R="/images/bg-desktop.jpeg",E="/images/bg-mobile.webp",C="/images/bg-desktop.webp";function Y(){const[a,m]=o.useState("splash"),[u,f]=o.useState(!1),[i,k]=o.useState(""),[l,p]=o.useState(""),[g,w]=o.useState(!1),[n,A]=o.useState(!0),[y,v]=o.useState(!1),I=o.useRef(null),r=_();if(o.useEffect(()=>{const h=window.matchMedia("(min-width: 1024px)").matches,t=document.createElement("link");return t.rel="preload",t.as="image",t.href=h?C:E,t.type="image/webp",t.setAttribute("fetchpriority","high"),document.head.appendChild(t),()=>{t.remove()}},[]),o.useEffect(()=>{const h=sessionStorage.getItem("token"),t=sessionStorage.getItem("role_id");if(h){const d=t?parseInt(t,10):null;if(d===3)r("/introduction",{replace:!0});else if(d===1||d===2){const j=F();r(L(j)?"/choose-dashboard":"/dashboard",{replace:!0})}else r("/dashboard",{replace:!0})}else A(!1)},[r]),n)return e.jsx(T,{message:"Loading sign in..."});const M=()=>{m("login"),requestAnimationFrame(()=>{requestAnimationFrame(()=>{w(!0)})})},N=()=>{w(!1),setTimeout(()=>m("splash"),420)},S=async h=>{var t,d,j;if(h.preventDefault(),!i||!l){c.error("Email and password are required");return}try{const x=await z.post("/api/login",{email:i,password:l}),{access_token:b,user:s}=x.data;P(b,s),s.role_id===3?r("/introduction",{replace:!0}):s.role_id===1||s.role_id===2?r(L(s)?"/choose-dashboard":"/dashboard",{replace:!0}):r("/dashboard",{replace:!0})}catch(x){if(z.isAxiosError(x)){const b=(t=x.response)==null?void 0:t.status,s=(j=(d=x.response)==null?void 0:d.data)==null?void 0:j.message;b===401?c.error("Invalid email or password"):b===403&&s?c.error(s):b===404?c.error("User not found"):c.error("Something went wrong. Please try again!")}else c.error("Unexpected error occurred!")}};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
